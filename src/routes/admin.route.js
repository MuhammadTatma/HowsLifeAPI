...
//controller
const {getDashboardInfo, getPasienStatistik, getKonsultasiStatistik, getDaftarPasien, getDaftarKonselor, getUmurPasien, getPasienKelamin } = require('../controllers/admin.controller')
...
router.route('/statistik/pasienumur').get(getUmurPasien)
